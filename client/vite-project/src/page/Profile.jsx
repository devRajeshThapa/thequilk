...
export default function Profile() {
  ...
  if(image){
    ...
    try {
      const response = await axios.post(
        "http://localhost:50001/upload/file", 
        formdata,
        {
          headers: {
  ...
  const handledeletepost = async (e, id) => {
    e.stopPropagation();
    try {
      const response = await axios.delete(`http://localhost:50001/upload/file/${id}`);
      ...
      <div className="inputcontainer">
        ...
        <div className="imagefilldiv">
          <div className="inputholder">
            <div className="inputpic">
              ...
              {image.length > 0 ? (image.map((current, index) => (
                ...
                <div className="divimagetwo"><p className="uploadparagraph">Upload</p></div> <div className="divimagetwo"><p className="uploadparagraph">Upload</p></div>
              </div>)}
          ...
          <div className="detaildiv">
            {image.length > 0 && title.length > 4 && <div className="thumbnail">
        ...
        <div className="inputpost">
          <div className="postholder">
            ...
            {postdata.length > 0 ? (filterdata &&filterdata.map((current, index) => {
              return (
                <div className="postdiv" key={index} onClick={(e) => { handleinfodiv(e, current._id) }}>

                  <div className="showpostanddelete">
                    <div className="show">
                      <img src={`http://localhost:50001/${current.thumbnail}`} alt="Selected" className="showimage" />
